...
1. `jupyter nbconvert --to html ./notebooks/project2.ipynb --output-dir ./docs --output index.html --TagRemovePreprocessor.enabled=True --TagRemovePreprocessor.remove_input_tags="['noshow']"` - converts the notebook into an HTML file. 
